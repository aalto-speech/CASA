...
Each configuration was trained 10 times: 5 runs at seed 1011 (a base run plus 4 repetitions,
...
The dev-selected CASA run (test RMSE **0.358**) is the model reported in the paper.
